...
public class DrilActivity extends BaseActivity implements OnInitListener{
	...
	private final static Pattern replaceSpecialCharactersPattern = Pattern.compile("(\\s(n|v|adj|adv|st|conj)(\\s)?)|(\\s(\\(n\\)|\\(v\\)|\\(adj\\)|\\(adv\\)|\\(conj\\))(\\s)?)|(\\[.*\\])");   
	...
	private Button rateButton1;
	private Button rateButton2;
	private Button rateButton3;
	private Button rateButton4;
	private Button rateButton5;
	...
	private int graduallyAlgorithmLimit = 5; 
	
	// je vymenena otazka / odpoved
	private boolean isCardSwitched = false;
	...
	private List<Word> activatedWords = null;
